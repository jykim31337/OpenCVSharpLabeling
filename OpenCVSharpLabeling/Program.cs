...
namespace OpenCVSharpLabeling
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var blob in cc.Blobs.Skip(1)) // Skip(1) mean background skip
            {
            ...
            ConnectedComponents.Blob maxBlob = cc.Blobs.Skip(1).OrderByDescending(b => b.Area).First(); // Get Max Blob And Skip(1) mean background skip
            ConnectedComponents.Blob maxBlobSimple = cc.GetLargestBlob(); //maxBlob and maxBlobSimple is same Blob
